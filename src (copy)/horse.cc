...
void Horse::Draw(Shader& shader)
{
    ...
    this->shader_.Use();
/*
    this->shader_.SetVector4f("externalColor", color);
...
this->shader_.SetVector3f("light.position", Controller::light_position_);
this->shader_.SetVector3f("light.position", Controller::c_pos);

this->shader_.SetVector3f("light.ambient", (glm::vec3(0.2f, 0.2f, 0.2f)));
this->shader_.SetVector3f("light.diffuse",(glm::vec3(0.5f, 0.5f, 0.5f)));
this->shader_.SetVector3f("light.specular", (glm::vec3(1.0f, 1.0f, 1.0f)));
